...
class RaceProgramCrawlerTest extends \PHPUnit\Framework\TestCase
{
    ...
    public function testCrawl()
    {
        ...
        $this->assertSame('静岡新聞社・静岡放送 New Year’s Cup', $response[6][1]['basic']['name']);
        $this->assertSame('予 選', $response[6][1]['basic']['type']);
        $this->assertSame(1800, $response[6][1]['basic']['distance']);
        ...
        $this->assertSame(49, $response[6][1]['racer'][0]['age']);
        $this->assertSame(35, $response[6][1]['racer'][1]['age']);
        $this->assertSame(27, $response[6][1]['racer'][2]['age']);
        $this->assertSame(26, $response[6][1]['racer'][3]['age']);
        $this->assertSame(21, $response[6][1]['racer'][4]['age']);
        $this->assertSame(29, $response[6][1]['racer'][5]['age']);
        $this->assertSame(50.8, $response[6][1]['racer'][0]['weight']);
        $this->assertSame(51.2, $response[6][1]['racer'][1]['weight']);
        $this->assertSame(50.6, $response[6][1]['racer'][2]['weight']);
        $this->assertSame(51.0, $response[6][1]['racer'][3]['weight']);
        $this->assertSame(50.1, $response[6][1]['racer'][4]['weight']);
        $this->assertSame(50.3, $response[6][1]['racer'][5]['weight']);
        $this->assertSame(0, $response[6][1]['racer'][0]['flying']);
        $this->assertSame(0, $response[6][1]['racer'][1]['flying']);
        $this->assertSame(0, $response[6][1]['racer'][2]['flying']);
        $this->assertSame(0, $response[6][1]['racer'][3]['flying']);
        $this->assertSame(0, $response[6][1]['racer'][4]['flying']);
        $this->assertSame(0, $response[6][1]['racer'][5]['flying']);
        $this->assertSame(0, $response[6][1]['racer'][0]['late']);
        $this->assertSame(0, $response[6][1]['racer'][1]['late']);
        $this->assertSame(0, $response[6][1]['racer'][2]['late']);
        ...
        $this->assertSame(0.00, $response[6][1]['racer'][0]['motorRate3']);
        $this->assertSame(0.00, $response[6][1]['racer'][1]['motorRate3']);
        $this->assertSame(0.00, $response[6][1]['racer'][2]['motorRate3']);
        $this->assertSame(0.00, $response[6][1]['racer'][3]['motorRate3']);
        $this->assertSame(0.00, $response[6][1]['racer'][4]['motorRate3']);
        $this->assertSame(0.00, $response[6][1]['racer'][5]['motorRate3']);
        ...
        $this->assertSame(0.00, $response[6][1]['racer'][0]['boatRate3']);
        $this->assertSame(0.00, $response[6][1]['racer'][1]['boatRate3']);
        $this->assertSame(0.00, $response[6][1]['racer'][2]['boatRate3']);
        $this->assertSame(0.00, $response[6][1]['racer'][3]['boatRate3']);
        $this->assertSame(0.00, $response[6][1]['racer'][4]['boatRate3']);
        $this->assertSame(0.00, $response[6][1]['racer'][5]['boatRate3']);
    }
}
