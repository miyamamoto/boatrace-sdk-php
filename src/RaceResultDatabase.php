        ...
        foreach ($data as $placeId => $places) {
            foreach ($places as $raceId => $races) {
                ...
                $storeData[] = [
                    ...
                    'course_1_racer_id'     => $frames[$races['course'][0]['frame']]['racerId'] ?? null,
                    'course_2_racer_id'     => $frames[$races['course'][1]['frame']]['racerId'] ?? null,
                    'course_3_racer_id'     => $frames[$races['course'][2]['frame']]['racerId'] ?? null,
                    'course_4_racer_id'     => $frames[$races['course'][3]['frame']]['racerId'] ?? null,
                    'course_5_racer_id'     => $frames[$races['course'][4]['frame']]['racerId'] ?? null,
                    'course_6_racer_id'     => $frames[$races['course'][5]['frame']]['racerId'] ?? null,
